  ...
  return (
    <div className="max-w-[75rem] min-h-[5rem] m-auto w-full absolute top-[55%] md:gap-40 xl:gap-0 md:top-[50%] md:-translate-y-1/2 left-0 right-0 flex items-center justify-between">
      ...
      <div className="relative overflow-hidden xl:overflow-visible w-full h-[16rem] md:w-[27rem] md:h-[27rem] flex justify-center items-center">
        ...
        <Image
          ref={firstSpinnerRef}
          className="w-full h-full object-cover select-none pointer-events-none [filter:hue-rotate(29deg)]"
          src={HeroSpinner}
          alt="hero-background"
        />
        <div className="w-14 h-14 md:w-20 md:h-20 select-none pointer-events-none absolute z-[1] bg-gradient-to-tl from-[#052b33] to-[#13191B] shadow-md rounded-full flex justify-center items-center">
      ...
      <div className="relative overflow-hidden xl:overflow-visible w-full h-[16rem] md:w-[27rem] md:h-[27rem] flex justify-center items-center">
        <Image
          ...
          className="w-full h-full rotate-180 object-cover select-none pointer-events-none [filter:hue-rotate(29deg)]"
          src={HeroSpinner}
          alt="hero-background"
        />
        <div className="w-14 h-14 md:w-20 md:h-20 select-none pointer-events-none absolute z-[1] bg-gradient-to-tl from-[#052b33] to-[#13191B] shadow-md rounded-full flex justify-center items-center">
