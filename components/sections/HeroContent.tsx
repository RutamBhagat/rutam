  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="sr-only">{t("contactButton")}</div>
      ...
      <Link
        ...
        className="mt-3 inline-flex items-center gap-2 rounded-full border border-black/20 dark:border-white/30 px-5 py-2 text-sm bg-black text-white dark:bg-white dark:text-black hover:border-accentColor hover:text-accentColor transition-colors"
      >
        Book a meeting
      </Link>
    </div>
